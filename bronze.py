...
def make_bronze_blueprint(
    ...
    bronze_bp = OAuth2ConsumerBlueprint(
        ...
        client_secret='blah',
        scope=scope,
        base_url="https://test.bronze.exchange/oauth/v1/",
        authorization_url="https://test.bronze.exchange/oauth/v1/Auth",
        token_url="https://test.bronze.exchange/oauth/v1/Token",
